...
- Use `motioneyes-animation-debug` when you can instrument the app and need precise timing, easing, or geometry values from MotionEyes logs.
...
| --- | --- | --- | --- |
| `motioneyes-animation-debug` | Timing, easing, geometry values, scroll offsets | MotionEyes log traces | Yes (temporary instrumentation) |
